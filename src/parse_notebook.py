...
def parse_notebook(out):
    ...
    in_built_functions = ['print','int','float','min','udiff','input','len','NotImplementedError','max','ValueError','round','nop']
    ...
    for cell in out.cells:
        if cell.cell_type == 'code':
            ...
            source_check = cell.source.split()
            
            removal_list = ['%matplotlib','notebook']
...
def main():
    ...
    out = nb.read("D:/VizierDB-JupyterIntegration/test_notebooks/002db2f3c193fa87be97b1fac814d577b6f1aa/002db2f3c193fa87be97b1fac814d577b6f1aa/notebooks/Computational Seismology/The Finite-Difference Method/fd_seismometer.ipynb",as_version=4)
